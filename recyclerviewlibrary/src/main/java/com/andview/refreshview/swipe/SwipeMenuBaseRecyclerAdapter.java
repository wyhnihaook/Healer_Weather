...
/**
 * Created by xz on 2016/8/28.
 *
 * 添加头标题的侧滑删除recyclerview
 *
 * author ：wyh
 */
public abstract class SwipeMenuBaseRecyclerAdapter<T,VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>{
