...
public abstract class XRefreshViewFooter extends LinearLayout implements IFooterCallBack {
...
//                Toast.makeText(mContext, "hhahaha", Toast.LENGTH_LONG).show();
...
//        show(true);
    ...
    public void onStateFinish(boolean hideFooter) {
        if (hideFooter) {
            ...
            mHintView.setOnClickListener(new OnClickListener() {@Override public void onClick(View v) {}});
        } else {
